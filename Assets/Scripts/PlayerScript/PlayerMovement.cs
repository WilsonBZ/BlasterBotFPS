...
public class PlayerMovement : MonoBehaviour
{
    ...
    private void HandleGravity()
    {
        ...
        {
            velocity.y = GameConstants.GROUND_STICK_VELOCITY;
        }
    ...
    private void OnControllerColliderHit(ControllerColliderHit hit)
    {
        ...
        if (isSliding && hit.collider.TryGetComponent<Enemy>(out var enemy))
        {
            ApplyDashKnockbackToEnemy(enemy);
        }
    }

    private void ApplyDashKnockbackToEnemy(Enemy enemy)
    {
        StopSlide();
    ...
    private void StopSlide()
    {
        ...
        velocity *= GameConstants.KNOCKBACK_VELOCITY_REDUCTION;
    }
